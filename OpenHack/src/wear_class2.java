...
public class wear_class2 extends JFrame {
//11~15
	File []list;
	File path;
	...
	public void Render()
	{
		...
		this.img1 = new ImageIcon("./image//Style//"+list[11].getName());
		this.img2 = new ImageIcon("./image//Style//"+list[12].getName());
		this.img3 = new ImageIcon("./image//Style//"+list[13].getName());
